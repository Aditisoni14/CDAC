class BinaryST{
 ...
 Node delete(Node root, int key)
	...
	public static void main(String args[])
	{
		...
		t1.printdelete(10);
		System.out.println("InOrder(deletion of leaf node):");
		t1.inorder();
		System.out.println();
		
		t1.printdelete(70);
		System.out.println("InOrder(delete node with one child):");
		t1.inorder();
		System.out.println();
		
		t1.printdelete(45);
		System.out.println("InOrder(delete root node ):");
		t1.inorder();
		System.out.println();
